...
const ko: Dict = {
  ...
  // 묵상집 관리
  tabWrite: "글 쓰기",
  tabCollections: "묵상집 관리",
  colsTitle: "묵상집",
  colsIntro: "직접 쓰는 묵상은 먼저 묵상집을 만들고, 그 묵상집에 날짜별로 글을 씁니다. 이메일에서 가져오는 묵상집은 지금처럼 자동으로 채워집니다.",
  colNew: "새 묵상집",
  colEdit: "이름 고치기",
  colNameKo: "이름 (한국어)",
  colNameEn: "이름 (English)",
  colDescKo: "소개 (한국어, 선택)",
  colDescEn: "소개 (English, 선택)",
  colSlug: "주소",
  colSlugHint: "주소에 쓰입니다. 영문 소문자·숫자·하이픈만.",
  colSlugBad: "주소는 영문 소문자·숫자·하이픈만 쓸 수 있습니다.",
  colSlugTaken: "이미 있는 주소입니다.",
  colOrder: "탭 순서",
  colNameRequired: "이름을 한 가지 언어 이상 적어 주세요.",
  colSaved: "묵상집을 저장했습니다.",
  colRemoved: "묵상집을 지웠습니다.",
  colRemoveConfirm: "이 묵상집을 지울까요? 글은 지워지지 않습니다.",
  colWrite: "여기에 글 쓰기",
  colEntriesOne: "글 {n}편",
  colEntriesMany: "글 {n}편",
  colEmptyHidden: "아직 글이 없어 독자에게는 보이지 않습니다.",
  colSourceEmail: "이메일에서 자동",
  colSourceWeb: "웹에서 자동",
  colSourceManual: "직접 입력",
  colSourceLocked: "가져오기 설정은 저장소의 collections.json 에서 관리합니다. 여기서는 이름과 소개만 고칠 수 있습니다.",
  cancel: "취소",
};
...
const en: Dict = {
  ...
  colsTitle: "Collections",
  colsIntro: "For devotionals you write yourself, first make a collection, then add an entry to it for each date. Collections fed by email keep filling themselves as before.",
  colNew: "New collection",
  colEdit: "Rename",
  colNameKo: "Name (Korean)",
  colNameEn: "Name (English)",
  colDescKo: "Description (Korean, optional)",
  colDescEn: "Description (English, optional)",
  colSlug: "URL name",
  colSlugHint: "Used in the address. Lowercase letters, numbers and hyphens only.",
  colSlugBad: "Use lowercase letters, numbers and hyphens only.",
  colSlugTaken: "That URL name is already taken.",
  colOrder: "Tab order",
  colNameRequired: "Give the collection a name in at least one language.",
  colSaved: "Collection saved.",
  colRemoved: "Collection removed.",
  colRemoveConfirm: "Remove this collection? Its entries are not deleted.",
  colWrite: "Write in this collection",
  colEntriesOne: "{n} entry",
  colEntriesMany: "{n} entries",
  colEmptyHidden: "No entries yet, so readers don't see it.",
  colSourceEmail: "From email",
  colSourceWeb: "From the web",
  colSourceManual: "Written here",
  colSourceLocked: "Import settings live in collections.json in the repository. Only the name and description can be changed here.",
  cancel: "Cancel",
};
